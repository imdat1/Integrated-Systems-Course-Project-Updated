...
namespace AppWebDB.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                //VALIDATE API TOKEN
                var tokenValidationResult = await ValidateHuggingFaceTokenAsync(Input.HuggingFaceAPIToken);
                if (!tokenValidationResult)
                {
                    ModelState.AddModelError(string.Empty, "Your HuggingFace API token is wrong!");
                    return Page();
                }
                ...
                user.HuggingFaceAPIToken = Input.HuggingFaceAPIToken;
        ...
        private async Task<bool> ValidateHuggingFaceTokenAsync(string token)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                // Additional checks can be performed on jsonResponse if needed
                return true;
            }
